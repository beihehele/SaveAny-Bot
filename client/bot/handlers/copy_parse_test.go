...
func TestParseCopyArgs(t *testing.T) {
	tests := []struct {
		...
		{name: "filter+count", args: []string{"-1001", "-1002", "msgre:a|b", "100"}, wantSource: "-1001", wantTarget: "-1002", wantFilter: "msgre:a|b", wantCount: 100},
		{name: "count only", args: []string{"-1001", "-1002", "50"}, wantSource: "-1001", wantTarget: "-1002", wantCount: 50},
		{name: "filter only", args: []string{"-1001", "-1002", "msgre:a|b"}, wantSource: "-1001", wantTarget: "-1002", wantFilter: "msgre:a|b", wantCount: 500},
		...
		{name: "count then filter", args: []string{"-1001", "-1002", "50", "msgre:a|b"}, wantSource: "-1001", wantTarget: "-1002", wantFilter: "msgre:a|b", wantCount: 50},
